...
public class TP02Q03{
    ...
    public static boolean pesquisaSequencial(String input[], String nomeSeq){
        boolean resp = false;
        for(int i = 0; i <= 31; i++){
            TP02Q03.contador++;
            if(input[i].compareTo(nomeSeq) == 0){
                resp = true;
                return resp;
            }else
                resp = false;
    ...
    public static void main(String[] args) throws Exception {
        ...
        while(nomeSeq.compareTo("FIM") != 0){
            TP02Q03.contador++;
            if(pesquisaSequencial(input, nomeSeq) == true){
                TP02Q03.contador++;
        ...
        RandomAccessFile Arq = new RandomAccessFile("matricula_sequencial.txt", "rw");

        Arq.writeChars("747358" + "\t" + diferenca + "\t" + TP02Q03.contador);
